...
import (
	...
	"gin-dubbogo-consumer/repo"
	"gin-dubbogo-consumer/util/cmd"
	"gin-dubbogo-consumer/util/common"
...
func (u *ImageRepoService) Page(req dto.SearchWithPage) (int64, interface{}, error) {
	total, ops, err := imageRepoRepo.Page(req.PageNo, req.PageSize, commonRepo.WithLikeName(req.Info), commonRepo.WithOrderBy("created_at desc"))
